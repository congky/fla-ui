@extends('flaCommonUI::layout.basic')

@section('title', 'Dashboard')

@section('custom-style')
    <link rel="stylesheet" href="{{asset('app/fla-ui/core/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('app/fla-ui/core/css/font-awesome.min.css')}}" />
@endsection

@section('custom-script')
    <script src="{{asset('app/fla-ui/controllers/common/login.controller.js')}}"></script>
@endsection
